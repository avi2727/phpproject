...
<body>
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<a class="navbar-brand" href="https://sourcecodester.com">Avinash</a>
		</div>
	</nav>
	<div class="col-md-3"></div>
	<div class="col-md-6 well">
		<h3 class="text-primary">UPDATE THROUGH MODAL</h3>
		...
		<table class="table table-bordered">
			...
			<tbody style="background-color:#fff;">
				...
				<tr>
					...
					<td><button class="btn btn-warning" data-toggle="modal" type="button" data-target="#update_modal<?php echo $fetch['user_id']?>"><span class="glyphicon glyphicon-edit"></span> Delete</button></td>
				</tr>
				<?php
